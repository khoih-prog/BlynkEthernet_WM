...
void setup()
{
  ...
  Serial.print(F("\nStart W5500_WM_Config_Teensy on ")); Serial.print(BOARD_NAME);
  ...
  Serial.println(F("Warning: W5x00 and ENC EthernetWebServer/Config-Portal only works with Teensy core v1.51"));
