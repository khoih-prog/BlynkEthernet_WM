  ...
  <div align=\"center\"> \
    <table> \
      <tbody> \
        ...
        <tr> \
          <td>Token</td> \
          <td><input type=\"text\" value=\"[[b_tok]]\" size=20 maxlength=64 id=\"b_tok\"></td> \
        </tr> \
        <tr> \
          <td>StaticIP</td> \
          <td><input type=\"text\" value=\"[[s_ip]]\" size=20 maxlength=64 id=\"s_ip\"></td> \
        </tr> \
        <tr> \
        ...
        <tr> \
          <td>Name</td> \
          <td><input type=\"text\" value=\"[[b_nam]]\" size=20 maxlength=32 id=\"b_nam\"></td> \
        </tr> \
        <tr> \
