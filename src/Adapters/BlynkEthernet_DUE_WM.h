...
<!DOCTYPE html><html><head><title>BlynkEthernet_DUE_WM</title><style>.em{padding-bottom:0px;}div,input{padding:5px;font-size:1em;}input{width:95%;}\
...
#error EPROM_START + CONFIG_DATA_SIZE > EEPROM_SIZE. Please adjust.
    ...
    bool getConfigData()
    {
      ...
      Blynk_Configuration* dataPointer = (Blynk_Configuration* ) dueFlashStorage.readAddress(EEPROM_START);
      memcpy(&BlynkEthernet_WM_config, dataPointer, sizeof(Blynk_Configuration));
