...
#define BlynkSimpleEthernetV2_0_WM_h
...
#else
#error This code for SAMD, SAM-DUE, Teensy (4.0, 3.x) boards, not ESP8266, ESP32, Mega nor STM32! Please check your Tools->Board setting.
#endif
